gcvlwls2d <- function(tt, ngrid=NULL, regular=rcov$regular, error=rcov$error, kern, rcov, h0=getMinb(rcov, regular=rcov$regular, out1=sort(unique(unlist(tt)))), verbose=TRUE, CV=FALSE) {
