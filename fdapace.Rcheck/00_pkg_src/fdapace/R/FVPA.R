...
#' @references
#' \cite{Hans-Georg M\"{u}ller, Ulrich Stadtm\"{u}ller and Fang Yao, "Functional variance processes." Journal of the American Statistical Association 101 (2006): 1007-1018}
#' @export
