...
#' 
#' References: Wang, J.L., Chiou, J.,  M\"{u}ller, H.G. (2016). Functional data analysis. Annual Review of Statistics and Its Application 3, 257--295
#' Chen, K., Zhang, X., Petersen, A., M\"{u}ller, H.G.  (2017). Quantifying infinite-dimensional data: Functional Data Analysis in action. 
...
#' Hao Ji
#'  
#' Hans-Georg M\"{u}ller \email{hgmueller@@ucdavis.edu}
