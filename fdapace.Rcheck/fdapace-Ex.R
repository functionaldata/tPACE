...
### Name: CreateCovPlot
### Title: Creates a covariance surface plot based on the results from
###   FPCA() or FPCder().
...
### Title: Create design plots for functional data. See Yao, F.,
###   M<c3><bc>ller, H.G., Wang, J.L. (2005). Functional data analysis for
###   sparse longitudinal data. J. American Statistical Association 100,
###   577-590 for interpretation and usage of these plots.  This function
###   will open a new device as default.
...
### Name: FCCor
### Title: Calculation of functional correlation between two simultaneously
###   observed processes.
### Aliases: FCCor
...
### Name: FPCAder
### Title: Obtain the derivatives of eigenfunctions/ eigenfunctions of
###   derivatives (note: these two are not the same)
### Aliases: FPCAder
...
### Name: GetMeanCI
### Title: Bootstrap pointwise confidence intervals for the mean function
###   for densely observed data.
### Aliases: GetMeanCI
...
### Title: Normalise sparse multivariate functional data
...
### Name: VCAM
### Title: Sieve estimation: B-spline based estimation procedure for
###   time-varying additive models. The VCAM function can be used to
###   perform function-to-scalar regression.
### Aliases: VCAM
...
### Name: WFDA
### Title: Time-Warping in Functional Data Analysis: Pairwise curve
###   synchronization for functional data
### Aliases: WFDA
...
### Name: predict.FPCA
### Title: Predict FPC scores and curves for a new sample given an FPCA
###   object
