...
#' @param lambda vector of size K specifying the standard deviations of each components (default: rep(1,k))
...
MakeGPFunctionalData <-function(N, M = 100, mu=NULL, k = 2, lambda = rep(1,k),  basisType='cos'){
