...
#' @param alpha The shrinkage factor (positive number) for bandwidth selection. See Han et al. (2016) (default is 0.6).
...
#' yHat <- sbf$mu+apply(fit$fam,1,'sum')
#' par(mfrow=c(1,1))
...
FAM <- function(Y,Lx,Lt,nEval=51,newLx=NULL,newLt=NULL,bwMethod=0,alpha=0.6,supp=c(-2,2),optns=NULL){
