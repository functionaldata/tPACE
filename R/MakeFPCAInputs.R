...
#' @param beSorted logical indicating if the returned lists Lt and Ly should be ensured to be sorted (Default: FALSE)
#' @return L list containing 3 lists each of length 'm', 'm' being the number of unique subject IDs
#' @export

MakeFPCAInputs <- function(IDs = NULL, tVec, yVec, na.rm=FALSE, beSorted = FALSE){
