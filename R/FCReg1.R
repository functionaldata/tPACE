...
FCReg <- function(vars, userBwMu, userBwCov, outGrid, 
                  kern='gauss', 
                  measurementError=TRUE, diag1D='none', 
                  useGAM = FALSE, returnCov=TRUE) {
  
  return(fdaconcur::ConcurReg(vars=vars, outGrid=outGrid,
                              userBwMu=userBwMu, userBwCov=userBwCov,
                              kern=kern,  measurementError=measurementError,
                              diag1D=diag1D,  useGAM=useGAM,
                              returnCov=returnCov))
}
