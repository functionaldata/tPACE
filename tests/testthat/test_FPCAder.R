...
plot(resDer$obsGrid, resDer$mu, type='l', ylim=c(-1, 1))
plot(resDer$obsGrid, resDer$muDer, type='l', ylim=c(-2, 2))
plot(resDer$workGrid, resDer$phi[, 1], type='l', ylim=c(-2, 2))
plot(resDer$workGrid, -resDer$phiDer[, 1], type='l')
plot(resDer$workGrid, resDer$phi[, 2], type='l', ylim=c(-2, 2))
plot(resDer$workGrid, -resDer$phiDer[, 2], type='l')
