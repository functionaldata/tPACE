...
test_that(" basic argument match MATLAB output ", { 
  ...
  expect_equal( sum(AA$tpairn) , 4.053285461728229e+02, tolerance = 1e-12, scale = 1)  
})
...
test_that(" basic argument match MATLAB output ", { 
  ...
  expect_equal( sum(BB$tpairn) , 6.330209554605514e+02, tolerance = 1e-12, scale = 1)  
})
...
test_that(" basic argument match MATLAB output ", { 
  ...
  expect_equal( sum(CC$tpairn) , 990, tolerance = 1e-12, scale = 1)  
})
...
test_that(" basic argument match MATLAB output ", { 
  ...
  expect_equal( sum(DD$tpairn) , 1100, tolerance = 1e-12, scale = 1)  
})
